  ...
  <section>
    <div class="container">
      ...
      <span class="h6 text-secondary">
        ...
        <span v-if="!login" class="h6 text-secondary"><br>By clicking register you are agreeing<br>to the <RouterLink class="link" to="/privacypolicy">Privacy Policy</RouterLink></span>
      </span>
    </div>
  </section>
